...
def Send_data():
    ...
    while current_segment_index <program_header_number:
        #if segments_header[current_segment_index]['p_paddr'] > START_ADDRESS and segments_header[current_segment_index]['p_paddr'] < FINAL_ADDRESS  :
